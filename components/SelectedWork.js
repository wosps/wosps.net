  ...
  return (
    <section>
      <div className={styles.header}>
        ...
        <Project title="Intruder Room" summary="A room browser and profile viewer for the video game, 'Intruder'." img="/intruder.png" slug="intruder-rooms" link="https://intruder.wosps.net" />
